					...
					if($infoproducto["precio"]==0){
						...
						echo '<div class="col-lg-6 col-md-8 col-xs-12">';
							...
							if($infoproducto["oferta"] != 0){
									...
									echo '<button class="btn btn-default btn-block btn-lg backColor agregarCarrito"  idProducto="'.$infoproducto["id"].'" imagen="'.$servidor.$infoproducto["portada"].'" titulo="'.$infoproducto["titulo"].'" precio="'.$infoproducto["precio"].'" peso="'.$infoproducto["peso"].'">';
