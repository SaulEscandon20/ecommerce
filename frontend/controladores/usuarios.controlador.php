			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   ...
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){
				...
				if($respuesta == "ok"){
					...
					$mail->setFrom('lavillitamueblerias@yahoo.com.mx', 'La Villita Mueblerías');

					$mail->addReplyTo('lavillitamueblerias@yahoo.com.mx', 'La Villita Mueblerías');
					
					$mail->Subject = "Por favor verifique su dirección de correo electrónico";	

					$mail->addAddress($_POST["regEmail"]);

					$mail->msgHTML('<div style="width:100%; background:#e8853b; position:relative; font-family:sans-serif; padding-bottom:40px">
						...
						<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
							...
							<h4 style="font-weight:100; color:#999; padding:0 20px">Para comenzar a usar su cuenta de La Villita Mueblerías, debe confirmar su dirección de correo electrónico</h4>
		...
		if(isset($_POST['mensajeContactenos'])){
			...
			preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["emailContactenos"])){
				...
				================================================*/
					...
					$mail->addAddress("lavillitamueblerias@yahoo.com.mx ");
